...
// Count of Species Bar chart
  ...
  FRAME3.append("g")
	...
	// Function that returns TRUE or FALSE according if a dot or bar is in the selection or not
	function isBrushed(brush_coords, cx, cy) {
		let x0 = brush_coords[0][0],
	      x1 = brush_coords[1][0],
	      y0 = brush_coords[0][1],
			  y1 = brush_coords[1][1]; 
		// This return TRUE or FALSE depending on if the point or bar is in the selected area
